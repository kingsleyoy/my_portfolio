...
const Project = () => {
  const projectInfo = [
    {
      picture: pic,
      msg: " Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus, aspernatur.",
    },
    {
      picture: pic,
      msg: " Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus, aspernatur.",
          ...
          {projectInfo.map((data, id) => (
            <div ref={scrollRef} key={id}>
              <motion.div
                ...
                viewport={{ once: false }}
                className=" mx-auto  h-[380px] grid-cols-1 md:h-96  rounded-md shadow-2xl group"
              >
